...
def HPC_OD(SV1,SV2,HPC,N=1,SV11=0,SV12=0,SV13=0,SV14=0):
    ...
    PRCSF_local = HPC.PR_SFDP * (1.0 - DEDG.DGC+0.43177)
    WACSF_local = HPC.CM_SFDP * (1.0 - DEDG.DGC+0.43177)
    #ETACSF_local = HPC.EF_SFDP * (1.0 - DEDG.DEC)
    ETACSF_local = 1 * (1.0 - DEDG.DEC+0.006)
...
def HPT_OD(SV1,SV2,HPT):
    ...
    ####加入取小数位后5位
    PRCSF_local = HPT.PR_SFDP * (1.0 - DEDG.DGT+0.2731)
    WACSF_local = HPT.CM_SFDP * (1.0 - DEDG.DGT+0.2731)
    #ETACSF_local = HPT.EF_SFDP * (1.0 - DEDG.DET)
    ETACSF_local = 1 * (1.0 - DEDG.DET-0.36886)
    if HPT.Adap:
