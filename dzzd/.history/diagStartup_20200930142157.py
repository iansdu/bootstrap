...
def Diagiter(xone):
    ...
    SV41midMF = SV41.MF
    HPT_DPIP.PR_OD = SV41.P/(SV45_P/(1-PD_HPout_DPIP.PD_DP))
    HPT_OD(SV41,SV42,HPT_DPIP)
    Mix_OD(SV42,SV43,SV_HPTRotor,HPTRotor_DP,SVF)
    PD_OD(SV43,SV45,PD_HPout_DPIP)

    
    error[0] = abs((HCom_DPIP.CW-HPT_DPIP.CW)/HCom_DPIP.CW)
    error[1] = abs(((SV41midMF-SV41.MF)/SV41.MF))
...
book = xlrd.open_workbook('0318p.xlsx')
...
fielddata_T25 = sheet1.col_values(2)
fielddata_P25 = sheet1.col_values(3)
fielddata_T3 = sheet1.col_values(4) 
fielddata_P3 = sheet1.col_values(5)
fielddata_T45 = sheet1.col_values(6)
fielddata_P45 = sheet1.col_values(7)
fielddata_HPCB1_valve = sheet1.col_values(8)
fielddata_HPCB2_valve = sheet1.col_values(9)
fielddata_HPTRotorDivide_valve = sheet1.col_values(10)
fielddata_HPTNGVDivide_valve = sheet1.col_values(11)
...
for i in range(nrows):
    ...
    HCom_DPIP.valve1 = fielddata_HPCB1_valve[i]
    HCom_DPIP.valve2 = fielddata_HPCB2_valve[i]
    Rotor_Divide.valve = fielddata_HPTRotorDivide_valve[i]
    NGV_Divide.valve = fielddata_HPTNGVDivide_valve[i]
