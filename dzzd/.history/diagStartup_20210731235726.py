...
def run(input):
    global SV25_T ,SV25_P ,SV3_T ,SV3_P ,SV45_T, SV45_P,SVF_MF
    global SV1,SV2,SV25,SV3,SV4,SV45,SV251,SV252,SVF
    SV1 = AF()
    SV2 = AF()
    SV21 = AF()
    SV24 = AF()
    ...
    fielddata_dp0=sheet1.col_values(8)
    fielddata_p0=sheet1.col_values(9)
    fielddata_IGV=sheet1.col_values(10)
