...
originalData=read_csv('originalData.csv',header=None)
originalData_all=originalData.values
originalData_all2=originalData_all[:,0]/originalData_all[:,1]/originalData_all[:,1]
np.savetxt('traindata_test.csv',originalData_all2, delimiter=",", fmt = '%s')
...
#####train 
trainset=read_csv('traindata_test.csv',header=None)
trainset.to_csv('data.csv',index =None,header =None)
traindata_all=trainset.values
# traindata_all=traindata_all[:,0]/traindata_all[:,1]/traindata_all[:,1]
