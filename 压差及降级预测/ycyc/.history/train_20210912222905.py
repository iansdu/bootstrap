...
originalData=read_csv('originalTrainData.csv',header=None)
...
np.savetxt('traindata.csv',originalData_all2, delimiter=",", fmt = '%s')
    ...
    for prei in range(n_item):
        ...
        for i in range(n_data):
            ...
            for j in range(n_step):
                ...
                train_x[i,n_step]=time[i]/3000  #换成读取的时间
        ...
        model.save(os.path.join("Modelnew" + str(prei+1)+ ".h5"))
